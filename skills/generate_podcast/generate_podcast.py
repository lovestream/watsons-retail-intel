...
def llm_generate_podcast_script(
    ...
    for model in models_to_try:
        try:
            ...
            char_hint = "⚠️ 这是一份无信号日报。口播稿控制在200-300中文字符，只说结论、数据、明日关注，不要硬凑字数。" if is_no_signal else "口播稿控制在1800-2500中文字符。"
            char_range = "200-300" if is_no_signal else "1800-2500"
